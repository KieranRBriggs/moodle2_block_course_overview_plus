...
$string['course_overview_plus:addinstance'] = 'Add a new Course Overview Plus block';
$string['course_overview_plus:myaddinstance'] = 'Add a new Course Overview Plus block to the My Moodle page';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on Course Overview Plus block, 0 will show all courses';
